...
public class MatrixRH {
  ...
  public MatrixRH(Coordinate c1, Coordinate c2) {
    _m = new double[4][4];
  ...
  public static void main(String args[]) {
    MatrixRH m = new MatrixRH(new Coordinate(200, 150, 0),
    ...
    m = new MatrixRH(new Coordinate(200, 0, 0), new Coordinate(800, 0, 0));
    System.out.println(m);
    ...
    m = new MatrixRH(new Coordinate(0, -100, 0), new Coordinate(0, 600, 0));
    System.out.println(m);
    c = new Coordinate(40, 0, 0);
    System.out.println(c);
    t_c = m.transform(c);
    ...
    m = new MatrixRH(new Coordinate(0, 0, 0), new Coordinate(0, 20, 0));
    System.out.println(m);
