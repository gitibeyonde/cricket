...
public class RunnerPlayerView extends PlayerView implements Animator, KeyListener {
  static Logger _cat = Logger.getLogger(RunnerPlayerView.class.getName());
  ...
  public RunnerPlayerView(PitchSkin skin, ClientPlayerModel model,
